...
public class TestString {
	...
	public static void main(String args[])
	{
		...
		System.out.println(name.lastIndexOf("o")); // 6
		...
		// StringBuffer synchronized = thread safe but slower perforamnce
		// StringBuilder not synchronized = NOT thread safe but faster perforamnce
		StringBuilder namesb=new StringBuilder("john");
		namesb.append(" doe");
		namesb.append(" ny");
		namesb.append(" usa");
